		...
		<div class="panel panel-primary">
 		...
 		<div class ="col-sm-8"> 			
			<div class="panel panel-secondary">
						...
						echo "<table border='1'>
							<tr>
							<center><th>Codigo de Hora</th> </center>
							<center> <th>Horario Actual </th></center>
							</tr>";

							while($row = mysqli_fetch_array($resultado))
							{
							echo "<tr>";
							echo "<center>  <td>" . $row['codhor'] . "</td> </center> ";
							echo "<center>  <td>" . $row['descripcion'] . "</td> </center>";
							echo "<center>  <td><a href=admin_horarios2.php?codhor=";echo $row['codhor'];echo">Modificar-</a></td> </center>";
								echo "<center>  <td><a href=admin_eliminarhor.php?codhor=";echo $row['codhor'];echo"> Eliminar</a></td> </center>";
						echo "</tr>";	
							echo "</tr>";
							}
							echo "</table>";
						?>
						<br>
						<form action="/laboratorio/admin_nuevohor.php">
    					<button class="btn btn-primary"> Nuevo Horario</button>
						</form>
