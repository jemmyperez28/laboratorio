 		...
 		<div class ="col-sm-8"> 			
			<div class="panel panel-secondary">
			 			<div class="panel-body">
							...
							<h3>Asistencia de el Código de reserva: <?php echo $_GET['codreserva']; ?></h3>
							</div>
							
							<?php

							$sql = "SELECT * FROM `reserva` WHERE codreserva= '".$codreserva."';";
						...
						<form method="post" action="admin_reportediarioprocesa3.php">

							<TD><input type="hidden" name="codreserva" value="<?php echo $codreserva;?>" /></TD>
							<div class="form-group">
										<div class="form-group">
										<label for="codigotext"> Asistio</label> 
	                			 		     <select name="asistio" id="asistio">
									<option value="<?php echo $asistio;?>"><?php echo $asistio;?></option><option value="si">si</option>
