			 			...
			 			<div class="panel-body">
			 				...
			 				<form method="post" action="reservar.php">
                						...
                						<div class="form-group">
                			 		    <label for="codigotext"> Fecha : </label>  <input type="date" id="fecha" name='fecha' size='9' value="" required /> 
                						</div>
										...
										<label for="codigotext"> Experimento :</label> 
											<select name="experimento" id="experimento" required>
...
<script src="jquery-3.2.1.min.js"> </script>
 		<script>
            ...
            $('#experimento').change(function(){
                ...
                var inputValue = $(this).val();
                //Ajax for calling php function
                $.post('get_data.php', { dropdownValue: inputValue ,dropdownValue1:inputValue1 , dropdownValue2:inputValue2 }, 
                	function(data){   
                	//alert('ajax completed. Response:  '+data);
                	$('#post').empty();            
                	$('#post').append(data);
