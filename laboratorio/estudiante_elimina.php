			 			...
			 			<div class="panel-body">
							 ...
							 # echo $consulta;
							  ...
							  $diferencia = $fechadb - $ahora;
								...
								if ($row['exp']=='exp1')
								{
									echo "ALERTA , Ud. Esta por eliminar el experimento Análisis de errores y medidas , esto implica que TODAS sus reservaciones seran borradas.";
									echo "<br>";
									echo "Esta seguro de continuar?";
									echo "<br> ";
									echo " <a href=estudiante_elimina_backup.php?codreserva=";echo $codreserva; echo"> CONTINUAR </a>";
									echo "<br> ";
									echo " <a href=estudiante_consulta.php> CANCELAR </a>";

								}
								else
								{
									echo "La reservacion sera eliminada";
									echo "<br>";
									echo "Esta seguro de continuar?";
									echo "<br> ";
									echo " <a href=estudiante_elimina_backup.php?codreserva=";echo $codreserva; echo"> CONTINUAR </a>";
