		...
		<div class="panel panel-primary">
 		...
 		<div class ="col-sm-8"> 			
			<div class="panel panel-secondary">
						...
						$sql="Insert into horas values ('".$codhor."','".$descripcion."');";

						if ($con->query($sql) === TRUE) {
						    echo " <center><h2> Nuevo Horario ingresado correctamente </h2> </center> " 
						    		  ." <br> <center> <h4> <a href=\"../laboratorio/admin_horarios.php\">Volver</a> </center> </h2>";
