		...
		<div class="panel panel-primary">
 		...
 		<div class ="col-sm-8"> 			
			<div class="panel panel-secondary">
						...
						echo "<table border='1'>
							<tr>
							<center><th> Fechas Inhabilitadas </th> </center>
							</tr>";

							while($row = mysqli_fetch_array($resultado))
							{
							echo "<tr>";
							echo "<center>  <td>" . $row['fecha'] . "</td> </center> ";
								echo "<center>  <td><a href=admin_eliminarfecha.php?fecha=";echo $row['fecha'];echo"> Eliminar</a></td> </center>";
						echo "</tr>";	
							echo "</tr>";
							}
							echo "</table>";
						?>
						<br>
						<form action="/laboratorio/admin_nuevafecha.php">
    					<button class="btn btn-primary"> Agregar Fecha </button>
						</form>
