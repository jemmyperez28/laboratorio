 		...
 		<div class ="col-sm-8"> 			
			<div class="panel panel-secondary">
			 			<div class="panel-body">
			 				...
			 				<form method="post" action="/laboratorio/admin_nuevohor2.php">
                						<div class="form-group">
                			 		    <label for="codigotext"> Codigo de Horario (4 digitos) (correlativo anteponer "00") </label>  <br>    <input type="text" name="codhor" value="" placeholder=""> </p>
                						</div>

                						<div class="form-group">
                			 		    <label for="codigotext"> Rango de Horario Formato EJM (08:00 - 08:45)  </label>    
